...
describe('Trigger.Basic', () => {
    ...
    function isPopupHidden() {
        return document.querySelector('.trigger-popup-hidden');
    }
    ...
    describe('getPopupContainer', () => {
        it('defaults to document.body', () => {
            ...
            const popupDomNode = document.querySelector('.trigger-popup');
            expect(
                popupDomNode.parentNode.parentNode.parentNode
            ).toBeInstanceOf(HTMLBodyElement);
        });
        ...
        it('wrapper children with div when multiple children', () => {
            ...
            expect(
                document.querySelectorAll('.trigger-popup-content').length
            ).toBeTruthy();
        });
    ...
    describe('action', () => {
        it('click works', () => {
            ...
            trigger(container, '.target');
            expect(document.querySelector('.x-content').textContent).toBe(
                'tooltip2'
            );
        ...
        it('nested action works', () => {
                ...
                render() {
                    return (
                        <Trigger
                            ...
                            popup={
                                <strong className="click-trigger">
                                    click trigger
                                </strong>
                            }
                        >
                            <Trigger
                                ...
                                popup={
                                    <strong className="hover-trigger">
                                        hover trigger
                                    </strong>
                                }
                            >
            ...
            trigger(container, '.target', 'mouseLeave');
            expect(
                hoverPopupDomNode.className.includes('-hidden')
            ).toBeTruthy();
            ...
            expect(
                clickPopupDomNode.className.includes('-hidden')
            ).toBeTruthy();
        });
    });
    ...
    describe('forceRender', () => {
        it("doesn't render at first time when forceRender=false", () => {
            ...
            expect(document.querySelector('.trigger-popup')).toBeFalsy();
        });
        ...
        it('click in popup of popup', () => {
            ...
            const innerTrigger = (
                <div style={{ background: 'rgba(255, 0, 0, 0.3)' }}>
                    ...
                    >
                        <div id="issue_9114_trigger">
                            another trigger in popup
                        </div>
                    </Trigger>
                </div>
            );
    ...
    describe('stretch', () => {
        ...
        ['width', 'height', 'min-width', 'min-height'].forEach((prop) => {
            it(prop, () => {
                ...
                expect(
                    document.querySelector('.trigger-popup').style
                ).toHaveProperty(prop);
            });
        });
    });
    ...
    it('support className', () => {
        const { container } = render(
            <Trigger
                ...
                popupAlign={placementAlignMap.left}
                popup={<strong className="x-content">tooltip2</strong>}
                classNames="className-in-trigger"
            >
                <div className="target">click</div>
            </Trigger>
        );
    ...
    it('support className in nested Trigger', () => {
        const { container } = render(
            <Trigger
                ...
                popupAlign={placementAlignMap.left}
                popup={<strong className="x-content">tooltip2</strong>}
                classNames="className-in-trigger-2"
            >
                <Trigger
                    action={['click']}
                    popupAlign={placementAlignMap.left}
                    popup={<strong className="x-content">tooltip2</strong>}
                    classNames="className-in-trigger-1"
                >
                    <div className="target">click</div>
                </Trigger>
            </Trigger>
        ...
        // TODO: Re-enable test for nested class ASAP
        expect(container.querySelector('div').className).toBe(
            'target className-in-trigger-1'
