...
export function generateTrigger(
    ...
    class Trigger extends React.Component<TriggerProps, TriggerState> {
        ...
        componentDidUpdate() {
            ...
            if (state.popupVisible) {
                ...
                if (!this.touchOutsideHandler) {
                    currentDocument =
                        currentDocument ||
                        props.getDocument(this.getRootDomNode());
        ...
        getRootDomNode = (): HTMLElement => {
            ...
            try {
                const domNode = findDOMNode<HTMLElement>(
        ...
        getContainer = () => {
            if (!this.portalContainer) {
                ...
                const popupContainer = getDocument(
                    this.getRootDomNode()
                ).createElement('div');
        ...
        fireEvents(type: string, e: Event) {
            const childCallback = (this.props.children as React.ReactElement)
                .props[type];
            if (childCallback) {
                childCallback(e);
            }
