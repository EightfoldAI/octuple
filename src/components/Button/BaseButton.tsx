...
export const BaseButton: FC<InternalButtonProps> = React.forwardRef(
  (
    ...
    const buttonBaseSharedClassNames: string = mergeClasses([
      classNames,
      {
        [styles.buttonSize3]: size === ButtonSize.Flex && largeScreenActive,
      },
      {
        [styles.buttonSize2]: size === ButtonSize.Flex && mediumScreenActive,
      },
      {
        [styles.buttonSize2]: size === ButtonSize.Flex && smallScreenActive,
      },
      {
        [styles.buttonSize1]: size === ButtonSize.Flex && xSmallScreenActive,
      },
    ...
    const buttonTextClassNames: string = mergeClasses([
      {
        [styles.buttonText3]: size === ButtonSize.Flex && largeScreenActive,
      },
      {
        [styles.buttonText2]: size === ButtonSize.Flex && mediumScreenActive,
      },
      {
        [styles.buttonText2]: size === ButtonSize.Flex && smallScreenActive,
      },
      {
        [styles.buttonText1]: size === ButtonSize.Flex && xSmallScreenActive,
      },
