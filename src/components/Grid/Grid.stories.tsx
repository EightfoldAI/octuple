                ...
                <main>
                    <article>
                        <section>
                            <h1>Grid</h1>
                            <p>
                                Our 12-column grid system is responsive, and the
                                columns will rearrange depending on the screen
                                size. It has a fixed gutter value, and a fixed
                                margin value depending on device type to
                                restructure the column layout best for the
                                viewport width.
                            </p>
                            <p>
                                The reason a 12-column grid is more popular than
                                an 8 or 10 columns grid is because of the
                                variety of ways it can be divided: into columns
                                of 1, 2, 3, 4, 6, or 12.
                            </p>
                        </section>
                        <section>
