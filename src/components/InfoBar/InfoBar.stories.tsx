                ...
                <main>
                    <article>
                        <section>
                            <h1>Info Bar</h1>
                            <p>
                                Info bars are used to display information people
                                will need to pay attention to immediately.
                                Depending on the severeity and context of the
                                alert, info bars can have close button on the
                                right and another call-to-action for someone to
                                take action. They spread across the full width
                                of a section.
                            </p>
                        </section>
                        <hr />
