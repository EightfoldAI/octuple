                ...
                <main>
                    <article>
                        <section>
                            ...
                            <p>
                                A Carousel is a slideshow for cycling within a
                                group of content. It runs with a group of
                                images, text, or html elements and incorporates
                                support for previous/next buttons. Carousel
                                sliders don't automatically normalize slide
                                dimensions. Use extra utilities or custom
                                methods to properly size content.
                            </p>
                            <h1>Carousel scroll mode</h1>
                            <p>
                                A horizontal scrolling menu component that
                                accepts mapped items and incorporates support
