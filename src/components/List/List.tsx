...
import React, { Key, useEffect, useRef, useState, forwardRef } from 'react';
...
export const List = forwardRef(
  <T extends any>(
    ...
    const handleItemKeyDown = (
      ...
      if (disableArrowKeys || disableKeys || disableKeyboardHandling) {
        return;
      }
      ...
      const arrowDecrement: boolean =
        htmlDir === 'rtl' ? arrowRight : arrowLeft;
      const arrowIncrement: boolean =
        htmlDir === 'rtl' ? arrowLeft : arrowRight;
    ...
    return (
      <div {...rest} className={classNames} style={style} ref={ref}>
        {getHeader()}
        {listType === 'ul' && (
          <ul
            id={id}
