  ...
  (
    ...
    return (
      ...
      >
        {_total > 0 && (
          <>
            {layout.includes(PaginationLayoutOptions.Sizes) && moreThanOnePage && (
            ...
            {layout.includes(PaginationLayoutOptions.Pager) && (
              <Pager
                ...
                quickNextIconButtonAriaLabel={quickNextIconButtonAriaLabel}
                quickPreviousIconButtonAriaLabel={
                  quickPreviousIconButtonAriaLabel
                }
              />
            )}
            {layout.includes(PaginationLayoutOptions.Next) && moreThanOnePage && (
              <DefaultButton
                ariaLabel={nextIconButtonAriaLabel}
                classNames={styles.paginationButton}
                key="next"
                disabled={_currentPage === getPageCount() || _pageCount === 0}
                iconProps={{
                  role: 'presentation',
