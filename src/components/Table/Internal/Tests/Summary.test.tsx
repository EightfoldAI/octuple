...
describe('Table.Summary', () => {
  ...
  const createTable = (
    props: JSX.IntrinsicAttributes &
      Pick<
        ...
        | 'sticky'
      > &
      Partial<Pick<OcTableProps<DefaultRecordType>, 'rowKey' | 'emptyText'>> &
      ...
      <OcTable
        ...
        summary={() => (
          <OcTable.Summary.Row>
            ...
            <OcTable.Summary.Cell index={2}>Bamboo</OcTable.Summary.Cell>
  ...
  describe('fixed summary', () => {
        ...
        <OcTable
          ...
          summary={() => (
            <OcTable.Summary fixed={fixed}>
              <OcTable.Summary.Row>
                <OcTable.Summary.Cell index={0}>Light</OcTable.Summary.Cell>
                <OcTable.Summary.Cell index={1}>Bamboo</OcTable.Summary.Cell>
                <OcTable.Summary.Cell index={2}>Little</OcTable.Summary.Cell>
              </OcTable.Summary.Row>
            </OcTable.Summary>
          )}
        />
    ...
    it('fixed top', () => {
      ...
      expect(wrapper.exists('.table-header tfoot.table-summary')).toBeTruthy();
    });
  });
});
