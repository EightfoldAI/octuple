...
describe('Table.FixedHeader', () => {
    ...
    it('should work', async () => {
        ...
        expect();
        expect(wrapper.find('colgroup col').at(0).props().style.width).toEqual(
            100
        );
        expect(wrapper.find('colgroup col').at(1).props().style.width).toEqual(
            200
        );
        expect(wrapper.find('colgroup col').at(2).props().style.width).toEqual(
            100
        );
    ...
    it('INTERNAL_COL_DEFINE', () => {
        ...
        expect(
            wrapper.find('table').last().find('colgroup col').first().props()
                .className
        ).toEqual('test-internal');
        expect(
            wrapper.find('table').first().find('colgroup col').first().props()
                .className
        ).toEqual('test-internal');
    });
