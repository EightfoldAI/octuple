...
describe('Table.Basic', () => {
  ...
  describe('renders empty text correctly', () => {
    it('ReactNode', () => {
      ...
      expect(wrapper.find('.table-placeholder').hostNodes().text()).toEqual(
        'No data'
      );
    });
  ...
  it('renders title correctly', () => {
    ...
    expect(wrapper.find('.table-title').hostNodes().text()).toEqual('title');
  });

  it('renders footer correctly', () => {
    const wrapper = mount(createTable({ footer: () => <p>footer</p> }));
    expect(wrapper.find('.table-footer').hostNodes().text()).toEqual('footer');
  });
  ...
  it('hover the tree table', () => {
    ...
    trs.forEach((tr, index) => {
      ...
      expect(currentClassName.includes('table-cell-row-hover')).toEqual(true);
