import type { Key, DataIndex } from '../OcTable.types';

const INTERNAL_KEY_PREFIX = 'OC_TABLE_KEY';
        ...
        if (clone) {
            Object.keys(clone).forEach((key) => {
                ...
                if (value && typeof value === 'object') {
                    ...
                    fillProps((obj as any)[key], value);
                } else {
