...
describe('legacy.dynamic-binding', () => {
    ...
    it('normal input', async () => {
        ...
        getInput(wrapper, '#text').simulate('change', {
            target: { value: '123' },
        });
        ...
        getInput(wrapper, '#number').simulate('change', {
            target: { value: '456' },
        });
    ...
    it('hidden input', async () => {
        ...
        const wrapper = mount(<Test mode />);
        getInput(wrapper, '#text1').simulate('change', {
            target: { value: '123' },
        });
        getInput(wrapper, '#text2').simulate('change', {
            target: { value: '456' },
        });
