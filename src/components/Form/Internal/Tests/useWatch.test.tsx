...
describe('useWatch', () => {
  ...
  test('form initialValue', async () => {
    const Demo = () => {
      ...
      return (
        <div>
          <OcForm form={form} initialValues={{ name: 'mia', other: 'other' }}>
            <OcField name="name">
              <Input />
            </OcField>
          </OcForm>
  ...
  test('list', async () => {
    const Demo = () => {
      ...
      return (
        <OcForm form={form} style={{ border: '1px solid red', padding: 15 }}>
    ...
    await act(async () => {
      ...
      await timeout();
      expect(wrapper.find('.values').text()).toEqual(JSON.stringify(['lola']));
    });
  });
  ...
  test('typescript', () => {
    ...
    const Demo = () => {
      ...
      const demo4 = OcForm.useWatch(['demo1', 'demo2', 'demo3', 'demo4'], form);
