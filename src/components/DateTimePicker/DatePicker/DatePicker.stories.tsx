...
const Single_Picker_TrapFocus_Story: StoryFn<typeof DatePicker> = (args) => {
  const onChange: DatePickerProps['onChange'] = (date, dateString) => {
    console.log(date, dateString);
  };
...
const Single_Picker_Readonly_Story: StoryFn<typeof DatePicker> = (args) => {
  return (
    <Stack direction="vertical" flexGap="m">
...
const Single_Picker_Choose_Time_Hide_Buttons_Story: StoryFn<
  typeof DatePicker
> = (args) => {
  const onChange = (
    value: DatePickerProps['value'],
...
const Range_Picker_Choose_Time_Hide_Buttons_Story: StoryFn<
  typeof RangePicker
> = (args) => {
  const onChange = (
    value: RangePickerProps['value'],
...
const Range_Picker_Readonly_Story: StoryFn<typeof RangePicker> = (args) => {
  return (
    <Stack direction="vertical" flexGap="m">
      <RangePicker
        {...args}
...
const Range_Picker_With_Aria_Labels_Story: StoryFn<typeof RangePicker> = (
  args
