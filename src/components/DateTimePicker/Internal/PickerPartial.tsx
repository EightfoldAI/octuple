...
import type { PartialMode, PartialRefProps, PickerMode } from './Picker.types';
...
type OmitType<DateType> = Omit<PickerPartialBaseProps<DateType>, 'picker'> &
    Omit<PickerPartialDateProps<DateType>, 'picker'> &
    Omit<PickerPartialTimeProps<DateType>, 'picker'>;
type MergedPickerPartialProps<DateType> = {
    picker?: PickerMode;
} & OmitType<DateType>;

function PickerPartial<DateType>(props: PickerPartialProps<DateType>) {
    const {
        classNames,
        style,
        locale,
