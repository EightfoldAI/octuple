...
describe('Picker.Range', () => {
    ...
    describe('value', () => {
        ...
        it('uncontrolled', () => {
            ...
            expect(
                isSame(onChange.mock.calls[0][0][0], '1990-09-13')
            ).toBeTruthy();
            expect(
                isSame(onChange.mock.calls[0][0][1], '1990-09-14')
            ).toBeTruthy();
    ...
    it('week picker can not click before start week', () => {
        ...
        expect(
            wrapper.findCell(4).hasClass('picker-cell-disabled')
        ).toBeTruthy();
        expect(
            wrapper.findCell(11).hasClass('picker-cell-disabled')
        ).toBeFalsy();
    });
    ...
    describe('onPartialChange is array args', () => {
        it('mode', () => {
            ...
            expect(onPartialChange.mock.calls[0][1]).toEqual([
                'month',
                'month',
            ]);
        });
    ...
    describe('hover className', () => {
        [
            ...
            it('year', () => {
                ...
                expect(
                    wrapper
                        .findCell(start)
                        .hasClass('picker-cell-range-hover-start')
                ).toBeTruthy();
                expect(
                ...
                expect(
                    wrapper
                        .findCell(end)
                        .hasClass('picker-cell-range-hover-end')
                ).toBeTruthy();
        ...
        it('range edge className', () => {
            ...
            expect(
                wrapper
                    .findCell(19)
                    .hasClass('picker-cell-range-hover-edge-end')
            ).toBeTruthy();
            expect(
                wrapper
                    .findCell(20)
                    .hasClass('picker-cell-range-start-near-hover')
            ).toBeTruthy();
            ...
            expect(
                wrapper
                    .findCell(21)
                    .hasClass('picker-cell-range-hover-edge-start')
            ).toBeTruthy();
            expect(
                wrapper
                    .findCell(20)
                    .hasClass('picker-cell-range-end-near-hover')
            ).toBeTruthy();
    ...
    describe('reorder onChange logic', () => {
        ...
        function testOrderOnTime(order: boolean, start: string, end: string) {
            it(`order: ${String(order)} when picker is time`, () => {
                ...
                expect(
                    isSame(onChange.mock.calls[0][0][0], start)
                ).toBeTruthy();
    ...
    it('should not disabled when week picker in diff year', () => {
        ...
        wrapper.openPicker(1);
        expect(
            wrapper.findCell('15').hasClass('picker-cell-disabled')
        ).toBeFalsy();
    });
