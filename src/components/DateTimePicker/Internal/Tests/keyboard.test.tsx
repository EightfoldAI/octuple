...
describe('Picker.Keyboard', () => {
    ...
    describe('datetime Tab control', () => {
        ...
        describe('PickerPartial', () => {
            describe('switch partials', () => {
                [
                    ...
                    it(name, () => {
                        ...
                        onSelect.mockReset();
                        expect(
                            wrapper.find('.picker-time-partial-column-active')
                                .length
                        ).toBeTruthy();
            ...
            it('Enter to next view', () => {
                ...
                partialKeyDown(wrapper, eventKeys.ENTER);
                expect(
                    wrapper.find('.picker-month-partial').length
                ).toBeTruthy();

                // Date
                partialKeyDown(wrapper, eventKeys.ENTER);
                expect(
                    wrapper.find('.picker-date-partial').length
                ).toBeTruthy();
            });
        });
    });
    ...
    describe('arrow trigger onSelect', () => {
        ...
        it('month', () => {
            ...
            expect(
                isSame(onSelect.mock.calls[0][0], '1990-08-03')
            ).toBeTruthy();
            ...
            expect(
                isSame(onSelect.mock.calls[0][0], '1991-08-03')
            ).toBeTruthy();
            ...
            partialKeyDown(wrapper, eventKeys.ARROWDOWN);
            expect(
                isSame(onSelect.mock.calls[0][0], '1991-11-03')
            ).toBeTruthy();
        });
        ...
        it('quarter', () => {
            ...
            partialKeyDown(wrapper, eventKeys.ARROWLEFT);
            expect(
                isSame(onSelect.mock.calls[0][0], '1990-06-03')
            ).toBeTruthy();
            ...
            partialKeyDown(wrapper, eventKeys.ARROWRIGHT, { ctrlKey: true });
            expect(
                isSame(onSelect.mock.calls[0][0], '1991-06-03')
            ).toBeTruthy();
            ...
            partialKeyDown(wrapper, eventKeys.ARROWDOWN);
            expect(
                isSame(onSelect.mock.calls[0][0], '1992-06-03')
            ).toBeTruthy();
        });
        ...
        it('year', () => {
            ...
            partialKeyDown(wrapper, eventKeys.ARROWLEFT);
            expect(
                isSame(onSelect.mock.calls[0][0], '1989-09-03')
            ).toBeTruthy();
            ...
            partialKeyDown(wrapper, eventKeys.ARROWRIGHT, { ctrlKey: true });
            expect(
                isSame(onSelect.mock.calls[0][0], '1999-09-03')
            ).toBeTruthy();
            ...
            partialKeyDown(wrapper, eventKeys.ARROWDOWN);
            expect(
                isSame(onSelect.mock.calls[0][0], '2002-09-03')
            ).toBeTruthy();
        });
