...
describe('Picker.Partial', () => {
  ...
  describe('Partial switch by picker', () => {
    ...
    [
      ...
      it(picker, () => {
        const wrapper = mount(<DayjsPickerPartial picker={picker as any} />);
        ...
        wrapper.selectCell('1999');
        expect(wrapper.find(`.picker-${picker}-partial`).length).toBeTruthy();
  ...
  describe('click button to switch', () => {
    it('date', () => {
      ...
      expect(wrapper.find('.picker-header-view').text()).toEqual('Aug1990');

      wrapper.clickButton('next');
      expect(wrapper.find('.picker-header-view').text()).toEqual('Sep1990');

      wrapper.clickButton('super-prev');
      expect(wrapper.find('.picker-header-view').text()).toEqual('Sep1989');
    ...
    ['month', 'quarter'].forEach((picker) => {
      it(picker, () => {
        ...
        wrapper.clickButton('super-prev');
        expect(wrapper.find('.picker-header-view').text()).toEqual('1989');

        wrapper.clickButton('super-next');
        expect(wrapper.find('.picker-header-view').text()).toEqual('1990');
      });
    });
    ...
    it('year', () => {
      ...
      wrapper.clickButton('super-prev');
      expect(wrapper.find('.picker-header-view').text()).toEqual('1980-1989');

      wrapper.clickButton('super-next');
      expect(wrapper.find('.picker-header-view').text()).toEqual('1990-1999');
    });
    ...
    it('decade', () => {
      ...
      wrapper.clickButton('super-prev');
      expect(wrapper.find('.picker-header-view').text()).toEqual('1800-1899');

      wrapper.clickButton('super-next');
      expect(wrapper.find('.picker-header-view').text()).toEqual('1900-1999');
    });
  });
      ...
      it('mode', () => {
        ...
        const wrapper = mount(
          <DayjsPickerPartial
            ...
            disabledDate={(date: dayjs.Dayjs) => date.year() === 1900}
          />
        );
  ...
  it('should render month correctly in rtl', () => {
    const wrapper = mount(<DayjsPickerPartial mode="month" direction="rtl" />);
