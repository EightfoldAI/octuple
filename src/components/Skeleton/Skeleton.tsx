...
export const Skeleton: FC<SkeletonProps> = React.forwardRef(
  (
    ...
    const skeletonClasses: string = mergeClasses([
      ...
      styles.skeleton,
      {
        [styles.pulse]: animation === SkeletonAnimation.Pulse && animating,
        [styles.wave]: animation === SkeletonAnimation.Wave && animating,
    ...
    const customStyle: React.CSSProperties = {
      ...(!fullWidth ? { width } : {}),
      ...(!IGNORE_CUSTOM_HEIGHT_VARIANTS.includes(variant) ? { height } : {}),
    };
