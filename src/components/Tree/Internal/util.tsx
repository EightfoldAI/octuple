...
import { OcTreeProps, AllowDrop } from './OcTree.types';
...
>(dragNodeKey: Key, keyEntities: Record<Key, DataEntity<TreeDataType>>): Key[] {
    // not contains self
...
export function calcDropPosition<TreeDataType extends BasicDataNode = DataNode>(
    ...
    let abstractDropNodeEntity: DataEntity<TreeDataType> =
        keyEntities[targetNode.props.eventKey];
 ...
 * @returns [string]
 */
export function calcSelectedKeys(selectedKeys: Key[], props: OcTreeProps) {
