...
describe('Tree Props', () => {
  ...
  describe('checkable', () => {
    it('node set checkable to `false`', () => {
      ...
      expect(container.querySelectorAll('.tree-checkbox')).toHaveLength(1);
    });
  });
    ...
    it('switcher leaf icon', () => {
      const { container } = render(
        ...
        >
          ...
          <TreeNode
            key="0-1"
            switcherIcon={switcherIcon('switcherLeafIconFromNode0-1', true)}
          />
          <TreeNode key="0-2">
            <TreeNode key="0-2-0" />
            <TreeNode
  ...
  it('titleRender', () => {
    ...
    expect(
      container.querySelectorAll('.tree-title')[0].querySelector('.light-span')
        .textContent
    ).toEqual('light');
    expect(
      container.querySelectorAll('.tree-title')[1].querySelector('.bamboo-span')
        .textContent
    ).toEqual('bamboo');
  });
});
