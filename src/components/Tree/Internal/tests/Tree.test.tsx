...
describe('Tree Basic', () => {
  ...
  describe('check', () => {
    ...
    it('check dynamic children when their parent is checked', () => {
      ...
      expect(container.querySelectorAll(`.${CHECKED_CLASSNAME}`)).toHaveLength(
        3
      );
    });
  ...
  describe('select', () => {
    it('fires select event', () => {
      ...
      const nodeContent = container.querySelector('.tree-node-content-wrapper');
  ...
  it('fires mouseEnter events', () => {
    ...
    fireEvent.mouseEnter(container.querySelector('.tree-node-content-wrapper'));
  ...
  it('fires mouseLeave events', () => {
    ...
    fireEvent.mouseLeave(container.querySelector('.tree-node-content-wrapper'));
