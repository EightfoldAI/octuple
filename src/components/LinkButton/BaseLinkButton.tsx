...
export const BaseLinkButton: FC<InternalLinkButtonProps> = React.forwardRef(
  (props: InternalLinkButtonProps, ref: Ref<HTMLAnchorElement>) => {
    const {
    ...
    const linkButtonBaseSharedClassNames: string = mergeClasses([
      classNames,
      {
    ...
    const linkButtonBaseClassNames: string = mergeClasses([
      linkButtonBaseSharedClassNames,
    ...
    return (
      <a
        ...
        className={linkButtonBaseClassNames}
        id={id}
