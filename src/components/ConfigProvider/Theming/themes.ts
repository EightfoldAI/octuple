...
export const themeDefaults: OcBaseTheme = {
    ...
    infoColor: '#4F5666',
    errorColor: '#993838',
    buttonDefaultForegroundColor: '#146da6',
    buttonHoverForegroundColor: '#054d7b',
    buttonFocusForegroundColor: '#054d7b',
    buttonActiveForegroundColor: '#054d7b',
    buttonVisitedForegroundColor: '#054d7b',
    buttonDefaultOutlineColor: '#146da6',
    buttonHoverOutlineColor: '#2c8cc9',
    buttonFocusOutlineColor: '#054d7b',
    buttonActiveOutlineColor: '#054d7b',
    buttonVisitedOutlineColor: '#054d7b',
    buttonPrimaryDefaultBackgroundColor: '#146da6',
    buttonPrimaryHoverBackgroundColor: '#2c8cc9',
    buttonPrimaryFocusBackgroundColor: '#054d7b',
    buttonPrimaryActiveBackgroundColor: '#054d7b',
    buttonPrimaryVisitedBackgroundColor: '#054d7b',
    buttonPrimaryDefaultBorderColor: '#146da6',
    buttonPrimaryHoverBorderColor: '#2c8cc9',
    buttonPrimaryFocusBorderColor: '#054d7b',
    buttonPrimaryActiveBorderColor: '#054d7b',
    buttonPrimaryVisitedBorderColor: '#054d7b',
    buttonDefaultBackgroundColor: '#fff',
    buttonHoverBackgroundColor: '#ebf7ff',
    buttonFocusBackgroundColor: '#ebf7ff',
    buttonActiveBackgroundColor: '#ebf7ff',
    buttonVisitedBackgroundColor: '#ebf7ff',
    buttonHoverVariantBackgroundColor: '#bce4ff',
};
